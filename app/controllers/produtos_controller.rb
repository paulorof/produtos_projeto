class ProdutosController < ApplicationController
  ...
  def index
      ...
      #@produtos = Categoria.find(params[:cat]).produtos
    #elsif params[:marca].blank?
      #@produtos = Marca.find(params[:marca]).produtos
    #else
      @produtos = Produto.busca(params[:busca],params[:page])
    #end
